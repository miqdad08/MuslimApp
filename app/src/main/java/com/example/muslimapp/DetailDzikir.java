...
public class DetailDzikir extends AppCompatActivity {
    ...
    private String[] nopagi = {"Doa yang dibaca di pagi hari",
            "1",
            "2",
            "3",
            "4",
    ...
    private String[] subjudulpagi = {"“Aku berlindung kepada Allah dari godaan syaitan yang terkutuk.”",
            ...
            "“Dengan menyebut nama Allah Yang Maha Pengasih lagi Maha Penyayang. Katakanlah: Aku berlindung kepada Rabb yang menguasai Shubuh, dari kejahatan makhluk-Nya, dan dari kejahatan malam apabila telah gelap gulita, dan dari kejahatan-kejahatan wanita tukang sihir yang menghembus pada buhul-buhul, dan dari kejahatan orang yang dengki apabila ia dengki”. (QS. Al Falaq: 1-5) (Dibaca 3 x)", "“Dengan menyebut nama Allah Yang Maha Pengasih lagi Maha Penyayang. Katakanlah: Aku berlindung kepada Rabb manusia. Raja manusia. Sembahan manusia, dari kejahatan (bisikan) syaitan yang biasa bersembunyi, yang membisikkan (kejahatan) ke dalam dada manusia, dari jin dan manusia.” (QS. An Naas: 1-6) (Dibaca 3 x)",
            ...
            "“Mahasuci Allah, aku memuji-Nya sebanyak bilangan makhluk-Nya, Mahasuci Allah sesuai ke-ridhaan-Nya, Mahasuci seberat timbangan ‘Arsy-Nya, dan Mahasuci sebanyak tinta (yang menulis) kalimat-Nya.”(Dibaca 3x)", "“Ya Allah, sesungguhnya aku meminta kepada-Mu ilmu yang bermanfaat, rizki yang halal, dan amalan yang diterima.” (Dibaca 1x)",
    ...
    private String[] nopetang = {"Doa yang dibaca di sore hari",
            "1",
            "2",
            "3",
            "4",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvMain = findViewById(R.id.rvmainDzikir);
